...
face_paseing_model.load_state_dict(torch.load(save_pth,map_location='cpu', weights_only=True))
...
ep0, total_it = makeup_model.resume(r'C:\Users\fatim\Downloads\CSD-MT-main\CSD-MT-main\CSD_MT\weights/CSD_MT.pth')
makeup_model.eval()
